var COLORS = ['#7E57C2', '#FF5722', '#E91E63', '#259B24', '#607D8B', '#2CB6D5', '#FD971F', '#26A694', '#FF5722', '#00BCD4', '#8BC34A', '#616161', '#FFD54F', '#03A9F4', '#795548'];
...
function initLanguages(id) {
  ...
  new GSortTable(id, {
    ...
    'endDrag': function () {
      ...
      if (trs.length > 1) {
        send('index.php/index/model/languages/action', 'action=move&data=' + trs.join(','), doFormSubmit);
      }
    }
  });
}
...
function showDebug() {
  ...
  var req = new GAjax().autoupdate('index.php/index/model/debug/action', 5, _get, function (xhr) {
